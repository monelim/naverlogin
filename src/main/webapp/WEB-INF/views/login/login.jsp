...
<body>
    <header id = "main_header">
        <div id = "top_header">
            <div class="logo">
                <a href="../site/main.html"><h1>CALVIN FLY</h1></a>
            </div>
            <div class="main_gnb">
                <ul id="main_list">
                    <li>
                        <a href="../man/man2.html">남성</a>
                        <div>
                            <div>
                                <ul class = "sub_menu">
                    ...
                    <li>
                        <a href="../performance/포퍼먼스.html">퍼포먼스</a>
                        <div>
                            <div>
                                <ul class = "sub_menu">
                                    <li class = "sub_menu_top">하이라이트</li>
                    ...
                    <li>
                        <a href="../off_season/off.html" class = "neon">오프시즌</a>
                        <div>
                            <div>
                                <ul class = "sub_menu">
                                    <li class = "sub_menu_top">남성용 의류</li>
